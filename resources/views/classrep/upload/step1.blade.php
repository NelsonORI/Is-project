...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl p-8">
        ...
        <form method="POST" action="{{ route('classrep.upload.step1') }}" enctype="multipart/form-data">
            ...
            {{-- Drop zone --}}
            <div id="dropzone"
                class="border-2 border-dashed border-gray-300 rounded-xl p-10 text-center cursor-pointer hover:border-indigo-400 hover:bg-indigo-50 transition mb-6"
                ...
                <div id="dropzone-selected" class="hidden">
                    <svg class="w-10 h-10 text-indigo-500 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">

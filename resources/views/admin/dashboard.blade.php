                    ...
                    <tbody>
                        @foreach($recentUsers as $user)
                            <tr class="border-b border-gray-50 last:border-0">
                                <td class="py-2.5 text-gray-700 font-medium">{{ $user->name }}</td>
                                ...
                                <td class="py-2.5 text-right">
                                    <a href="{{ route('admin.users', ['search' => $user->email]) }}" class="text-xs text-gray-500 hover:text-indigo-600 border border-gray-200 rounded px-2.5 py-1 inline-block">
                                        Manage
                                    </a>
                                </td>
                            </tr>
